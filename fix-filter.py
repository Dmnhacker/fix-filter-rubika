...
code1=print(""""fix.filter.rubika.ir(rubika.ir/"""+Ent+""")This account was for a child's study and was filtered by hackers please delete his account Please fix filter this account"""")
code2=print(""""order=fix.filter>rubika.ir(rubika.ir/"""+Ent+""")This account has not been violated, remove it from the filter"""")
...
print(color.yellow+f" code4 ",end='',flush=True)
sleep(1)
